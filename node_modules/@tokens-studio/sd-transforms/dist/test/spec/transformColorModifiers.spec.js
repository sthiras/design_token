...
runTransformSuite(transformColorModifiers, {
    value: '#C14242',
    type: 'color',
    $extensions: {
        'studio.tokens': {
...
describe('transform color modifiers', () => {
    describe('lighten', () => {
        it('supports lighten color modifiers in all 4 spaces', () => {
            ...
            expect(transformColorModifiers(token(ColorSpaceTypes.P3))).to.equal('color(display-p3 0.76 0.44 0.42)');
            expect(transformColorModifiers(token(ColorSpaceTypes.SRGB))).to.equal('rgb(80.5% 40.7% 40.7%)');
    ...
    describe('darken', () => {
        it('supports darken color modifiers in all 4 spaces', () => {
            ...
            expect(transformColorModifiers(token(ColorSpaceTypes.P3))).to.equal('color(display-p3 0.56 0.24 0.22)');
            expect(transformColorModifiers(token(ColorSpaceTypes.SRGB))).to.equal('rgb(60.5% 20.7% 20.7%)');
            // without space, return original
            expect(transformColorModifiers(token(''))).to.equal('#C14242');
        });
    });
    describe('mix', () => {
        it('supports mix color modifiers in all 4 spaces', () => {
            ...
            expect(transformColorModifiers(token(ColorSpaceTypes.P3))).to.equal('color(display-p3 0.47 0.47 0.47)');
            expect(transformColorModifiers(token(ColorSpaceTypes.SRGB))).to.equal('rgb(46.6% 46.6% 46.6%)');
            // without space, return original
    ...
    describe('transparentize', () => {
        it('supports transparentize color modifiers in all 4 spaces', () => {
            ...
            expect(transformColorModifiers(token(ColorSpaceTypes.HSL))).to.equal('hsl(0 50.6% 50.8% / 0.2)');
            expect(transformColorModifiers(token(ColorSpaceTypes.LCH))).to.equal('lch(47.1 59.4 29.7 / 0.2)');
            expect(transformColorModifiers(token(ColorSpaceTypes.P3))).to.equal('color(display-p3 0.7 0.29 0.28 / 0.2)');
            expect(transformColorModifiers(token(ColorSpaceTypes.SRGB))).to.equal('rgb(75.7% 25.9% 25.9% / 0.2)');
        });
    });
