...
runTransformSuite(checkAndEvaluateMath);
describe('check and evaluate math', () => {
    ...
    it('supports multi-value expressions with math expressions', () => {
        ...
        expect(checkAndEvaluateMath('linear-gradient(90deg, #354752 0%, #0b0d0e 100%)')).to.equal('linear-gradient(90deg, #354752 0%, #0b0d0e 100%)');
    });
